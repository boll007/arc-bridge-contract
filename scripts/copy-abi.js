...
(() => {
  ...
  fs.writeFileSync(path.join(__dirname, '../../server/libs/contract/rollup.json'), JSON.stringify(json, null, 2));
...
(() => {
  ...
  fs.writeFileSync(path.join(__dirname, '../../server/libs/contract/erc20.json'), JSON.stringify(json, null, 2));
  // eslint-disable-next-line no-console
